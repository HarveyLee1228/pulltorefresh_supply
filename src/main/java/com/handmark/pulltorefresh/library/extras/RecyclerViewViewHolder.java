...
public class RecyclerViewViewHolder extends RecyclerView.ViewHolder {
    ...
    //初始化的设置
    protected RecyclerViewViewHolder(View itemView) {
        super(itemView);
    ...
    public <T> RecyclerViewViewHolder(View itemView, final RecyclerViewAdapter<T> adapter) {
        super(itemView);
        RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.WRAP_CONTENT);
        itemView.setLayoutParams(lp);
        this.mViews = new SparseArray<>();
     ...
     * @return 当前对象
     */
    public RecyclerViewViewHolder setImageResource(int viewId, int drawableId) {
     ...
     * @return 当前对象
     */
    public RecyclerViewViewHolder setImageBitmap(int viewId, Bitmap bm) {
        ImageView view = getView(viewId);
