 ...
 */
public abstract class RecyclerViewAdapter<T> extends RecyclerView.Adapter<RecyclerViewViewHolder> {


    private ArrayList<View> mHeaderViews = new ArrayList<View>(); //头视图
    private ArrayList<View> mFooterViews = new ArrayList<View>();   //尾视图
     ...
     * @param itemLayoutId
     */
    protected RecyclerViewAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    private void onBindAdvanceViewHolder(RecyclerViewViewHolder holder, int i) {
     ...
     */
    public abstract void convert(RecyclerViewViewHolder holder, T item);
     ...
     * @return Holder对象
     */
    protected RecyclerViewViewHolder onCreateAdvanceViewHolder(ViewGroup parent, int viewType) {

        View v = mInflater.inflate(mItemLayoutId, null);
        return new RecyclerViewViewHolder(v, this);
    }
    ...
    class HeaderHolder extends RecyclerViewViewHolder {
    ...
    class FooterHolder extends RecyclerViewViewHolder {
